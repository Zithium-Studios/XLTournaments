...
package net.zithium.tournaments.utility.color;

import com.google.common.collect.ImmutableMap;
import net.zithium.tournaments.utility.color.patterns.GradientPattern;
import net.zithium.tournaments.utility.color.patterns.Pattern;
import net.zithium.tournaments.utility.color.patterns.RainbowPattern;
import net.zithium.tournaments.utility.color.patterns.SolidPattern;
...
public class IridiumColorAPI {
     ...
     * @since 1.0.0
     */
    public static @NotNull String process(String string) {
     ...
     * @since 1.0.0
     */
    public static @NotNull String color(String string, Color color) {
     ...
     * @since 1.0.0
     */
    public static @NotNull String color(String string, Color start, Color end) {
     ...
     * @since 1.0.3
     */
    public static @NotNull String rainbow(String string, float saturation) {
        StringBuilder specialColors = new StringBuilder();
        for (String color : SPECIAL_COLORS) {
            if (string.contains(color)) {
                specialColors.append(color);
